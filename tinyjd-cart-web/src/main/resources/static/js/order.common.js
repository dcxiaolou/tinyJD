...
function isGbOrEn(value){
    ...
    if (com.dcxiaolou.gmall.service(re) != -1){
      return true;
    } else {
      return false;
    }
...
function getParam(paramName)
{
    var paramValue = "";
    isFound = false;
    if (com.dcxiaolou.gmall.service.indexOf("?") == 0 && com.dcxiaolou.gmall.service.indexOf("=")>1)
    {
        arrSource = unescape(com.dcxiaolou.gmall.service).substring(1,com.dcxiaolou.gmall.service.length).split("&");
        i = 0;
