$(function () {
    ...
    $.getJSON("catalogLoader", function (data) {
                ...
                $.each(ctgnumArray, function (i, ctg1Id) {
                    ...
                    $.each(ctg2list, function (i, ctg2) {
                        ...
                        $.each(ctg3List, function (i, ctg3) {
                            var cata3link = $("<a href=\"http://search.gmall.com:8083/search?catalog3Id=" + ctg3.id + "&keyword=" + ctg3.name + "&valueId=\" style=\"color: #999;\">" + ctg3.name + "</a>");
                            li.append(cata3link);
